...
This program can be used as an OpenAI reverse proxy for AI character chatting web interfaces such as [VenusAI](https://www.venuschat.ai/) and [JanitorAI](https://janitorai.com/) if you want to use a model that has lesser to no guardrails and is almost completely uncensored for all you degenerates out there.
